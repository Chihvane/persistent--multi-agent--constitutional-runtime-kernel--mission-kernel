...
<div class="chapter-callout-label">Scenario / 情景 / 类比</div>
**情景 1.1** · 产品 A → 顺便 B → 漂移
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_1.png" alt="Figure 1.1 Task ownership drift through support input and compaction" loading="lazy">
  <figcaption>Figure 1.1 Task ownership drift through support input and compaction</figcaption>
</figure>
</div>
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_2.png" alt="Figure 1.2 A support-level recon request is silently promoted to a main-line action" loading="lazy">
...
<div class="chapter-callout-label">Definition / 结构规则</div>
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_3.png" alt="Figure 1.3 Memory must pass an evidence gate before it can affect current state" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_4.png" alt="Figure 1.4 The persona shell cannot become the law source" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_5.png" alt="Figure 1.5 Authority is a set of typed objects on the mission record, not a side-effect of execution" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_6.png" alt="Figure 1.6 Group chat (left) vs mission-governed orchestration (right)" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_6b.png" alt="Figure 1.6b Council lifecycle for a single mission" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_7.png" alt="Figure 1.7 Tool list vs capability registry" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_8.png" alt="Figure 1.8 Continue is only one of six lawful runtime actions" loading="lazy">
...
<figure class="chapter-figure">
  <img src="./package-v3/diagrams/fig_1_9.png" alt="Figure 1.9 Eight defects are different expressions of one overloaded conversation structure" loading="lazy">
