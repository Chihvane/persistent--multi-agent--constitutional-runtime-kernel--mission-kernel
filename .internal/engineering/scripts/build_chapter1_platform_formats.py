...
EDITIONS = [
    Edition(
        slug="zh",
        label="Chinese",
        source_dir=ROOT / "chapter1/final-draft-v3/package-v3",
        github_page=ROOT / "chapter1/final-draft-v3/github-pages.md",
        github_title="Chapter 1 GitHub Pages Edition",
        github_permalink="/chapter1/final-draft-v3/github-pages/",
        github_pdf_link="../package-v3/chapter1.pdf",
        github_diagram_prefix="../package-v3/diagrams/",
        substack_dir=ROOT / ".internal/unpublished/publishing/chapter-01/substack",
        hugging_face_dir=ROOT / ".internal/unpublished/publishing/chapter-01/hugging-face",
        manifest=ROOT / ".internal/unpublished/publishing/chapter-01/conversion-manifest.md",
        hf_title="From Single-Agent OS to Constitutional Runtime - Chapter 1",
    ),
    Edition(
        slug="en",
        label="English",
        source_dir=ROOT / "chapter1/final-draft-v3/package-v3-en",
        github_page=ROOT / "chapter1/final-draft-v3/en/github-pages.md",
        github_title="Chapter 1 English GitHub Pages Edition",
        github_permalink="/chapter1/final-draft-v3/en/github-pages/",
        github_pdf_link="../../package-v3-en/chapter1.pdf",
        github_diagram_prefix="../../package-v3-en/diagrams/",
        substack_dir=ROOT / ".internal/unpublished/publishing/chapter-01/en/substack",
        hugging_face_dir=ROOT / ".internal/unpublished/publishing/chapter-01/en/hugging-face",
        manifest=ROOT / ".internal/unpublished/publishing/chapter-01/en/conversion-manifest.md",
