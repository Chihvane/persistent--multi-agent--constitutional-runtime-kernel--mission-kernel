...
`chapter1/final-draft-v3/package-v3/`
...
1. Publish the Chapter 1 landing page at `chapter1/final-draft-v3/`.
...
1. Use `.internal/unpublished/publishing/hugging-face-readme.md` as the short project README base.
...
2. GitHub Wiki orientation pages from `.internal/unpublished/wiki/`.
3. Hugging Face short project README linking back to GitHub Pages.
4. Substack article prepared from the final Markdown and checked against the final PDF.
