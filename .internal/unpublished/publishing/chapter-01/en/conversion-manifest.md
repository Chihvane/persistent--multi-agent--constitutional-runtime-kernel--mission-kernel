...
- Canonical final PDF: `chapter1/final-draft-v3/package-v3-en/chapter1.pdf`
- Source Markdown from the same package: `chapter1/final-draft-v3/package-v3-en/chapter1.md`
...
- GitHub Pages: `chapter1/final-draft-v3/en/github-pages.md`
- Substack: `.internal/unpublished/publishing/chapter-01/en/substack/chapter1.substack.md`
- Substack notes: `.internal/unpublished/publishing/chapter-01/en/substack/README.md`
- Hugging Face: `.internal/unpublished/publishing/chapter-01/en/hugging-face/README.md`
- Hugging Face notes: `.internal/unpublished/publishing/chapter-01/en/hugging-face/PUBLISHING_NOTES.md`
