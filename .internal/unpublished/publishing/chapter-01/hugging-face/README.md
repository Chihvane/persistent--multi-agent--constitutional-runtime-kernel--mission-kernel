...
![Figure 1.1 Task ownership drift through support input and compaction](assets/fig_1_1.png)

<sub>Figure 1.1 Task ownership drift through support input and compaction</sub>
